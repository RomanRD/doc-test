...
# -*- coding: utf-8 -*-
#
# ImCMS documentation build configuration file, created by
# sphinx-quickstart
#
...
latex_documents = [
  (master_doc, 'ImCMS.tex', 'ImCMS Documentation',
   'imCodePartnerAB', 'manual'),
]
...
man_pages = [
    (master_doc, 'imcms', 'ImCMS Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ImCMS', 'ImCMS Documentation',
   author, 'ImCMS', 'ImCMS Documentation',
   'Java Development'),
]
